export { CmdFIcon } from "./cmdf.svg";
export { HackCampIcon } from "./hackcamp.svg";
export { NwHacksIcon } from "./nwhacks.svg";
export { NwPlusIcon } from "./nwplus.svg";
...
export { NwHacksColouredIcon } from "./nwhacks-coloured.svg";
