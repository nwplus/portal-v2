import { ApplicationFaqs } from "@/components/features/application/application-faqs";
import { Navbar } from "@/components/features/application/navbar";
import { StatusBlurb } from "@/components/features/application/status-blurb";
          ...
          <div className="flex flex-col items-start gap-4 md:gap-10">
            ...
            <div className="flex flex-col items-start gap-3">
              <div className="flex flex-row flex-wrap gap-3 md:gap-6">
                <Tag
                  variant="active"
                  className="gap-2 pr-3 pl-3 text-xs md:pr-6 md:pl-5 md:text-base"
                >
